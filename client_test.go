...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Characters.List(context.Background(), believe.CharacterListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Characters.List(cancelCtx, believe.CharacterListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Characters.List(deadlineCtx, believe.CharacterListParams{})
		if err == nil {
