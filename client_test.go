...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Characters.GetAllCharacters(context.Background(), believe.CharacterGetAllCharactersParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Characters.GetAllCharacters(context.Background(), believe.CharacterGetAllCharactersParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Characters.GetAllCharacters(cancelCtx, believe.CharacterGetAllCharactersParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Characters.GetAllCharacters(deadlineCtx, believe.CharacterGetAllCharactersParams{})
		if err == nil {
