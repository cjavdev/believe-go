...
//
// If your params struct uses [param.Field], you must provide either [MarshalJSON], [URLQuery], and/or
// [MarshalForm] functions. It is undefined behavior to use a struct uses [param.Field] without
// specifying how it is serialized.
//
